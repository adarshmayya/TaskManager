            ...
            <div className='doing'>
                ...
                <ul className="doing-list">
                    {this.props.task_list.map((item) => {
                        return <ListItem description={item.description} key={"doing_"+ item._id} id={item._id} checkedState={item.finished} clickHandler={this.taskCompleteHandler} onDescpChange={this.props.onDescpChange}/>
                    })}
                </ul>
